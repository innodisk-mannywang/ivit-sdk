...
>
> **📘 完整教學**：[自定義模型整合指南](./tutorials/CUSTOM_MODEL_GUIDE.md) - 包含三個實際範例：前後處理不匹配、不支援的運算子、自定義輸出格式。
...
- [API 文件](./api/API-SPEC-001-ivit-sdk.md)
- [架構設計](./architecture/ADR-001-system-architecture.md)
- [產品需求](./PRD/PRD-001-ivit-sdk.md)
